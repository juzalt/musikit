  ...
  return(
    <>
      <div className="container">
        <img src="https://upload.wikimedia.org/wikipedia/commons/2/26/Spotify_logo_with_text.svg" alt="Spotify logo" className="navbar__large-logo"/>
        <ul>
          <li className="navbar-group">
            <div className="navBar-item--with-icon-left">
